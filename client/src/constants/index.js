export const surpriseMePrompts = [
    "une image très détaillé en 4K d'un petit coworking de 10 places avec 4 bureaux avec les pieds blancs et le plateau couleur bambou de 120x60cm, les 6 autres places sur une banquette avec long table de 50*180cm. Les places sont tournées les unes vers les autres avec un passage au milieux. C'est dans une pièce chaleureuse d'environ 25m2 avec une vitrine et une porte sur un seul coté. les bureaux ont des écrans incurvées et des chaises de bureaux. l'ensemble soit être chaleureux et design. Et ce sont des bureayx assis debout",
